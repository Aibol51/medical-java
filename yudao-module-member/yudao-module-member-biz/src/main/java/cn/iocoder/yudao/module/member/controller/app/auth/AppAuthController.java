...
public class AppAuthController {
    ...
    @PermitAll
    public CommonResult<AppAuthLoginRespVO> register(@RequestBody @Valid AppAuthRegisterReqVO registerReqVO) {
        return success(authService.smsRegister(registerReqVO));
    }
