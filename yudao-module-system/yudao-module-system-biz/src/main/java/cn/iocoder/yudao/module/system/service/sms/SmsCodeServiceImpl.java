...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    public void useSmsCode(SmsCodeUseReqDTO reqDTO) {
        ...
        System.out.print("useSmsCode");
        System.out.print(lastSmsCode);
        // 使用验证码
    ...
    private SmsCodeDO validateSmsCode0(String mobile, String code, Integer scene) {
        log.info("lastSmsCode: {}", code);
        // 校验验证码
        SmsCodeDO lastSmsCode = smsCodeMapper.selectLastByMobile(mobile, code, scene);
        log.info("lastSmsCode: {}", lastSmsCode);
        System.out.print("validateSmsCode0");
        System.out.print(lastSmsCode);
        // 若验证码不存在，抛出异常
        if (lastSmsCode == null) {
            log.info("validateSmsCode0:{}", code);
